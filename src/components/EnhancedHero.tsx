      ...
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            Hi, I'm <span className="bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">Pooja Shankar Thube</span>
          </h1>
          <h2 className="text-2xl md:text-3xl mb-6 text-muted-foreground font-medium">
            PHP & WordPress Developer
          </h2>
          <p className="text-lg mb-8 text-muted-foreground max-w-2xl mx-auto">
            Building clean, powerful, and user-focused web solutions.
          </p>
